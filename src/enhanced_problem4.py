...
class Sort012Analyzer:
    ...
    def benchmark_algorithms(sizes: List[int]) -> None:
        ...
        print("="*70)
        print(f"{'Size':<8} {'Counting':<12} {'In-place':<12} {'Functional':<12} {'Speedup':<10}")
        print("-" * 70)
        ...
        for size in sizes:
            ...
            print(f"{size:<8} {counting_time*1000:<12.3f} {inplace_time*1000:<12.3f} "
...
def run_comprehensive_tests() -> None:
    ...
    test_cases = [
        ...
        ([2, 1, 2, 0, 0, 2, 1, 0, 1, 0, 0, 2, 2, 2, 1, 2, 0, 0, 0, 2, 1, 0, 2, 0, 0, 1], "Long array"),
        ([0], "Single element 0"),
        ([1], "Single element 1"),
        ([2], "Single element 2"),
