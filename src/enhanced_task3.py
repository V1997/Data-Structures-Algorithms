...
class PhoneNumberAnalyzer:
    ...
    def __init__(self):
        self.bangalore_calls = []
        self.called_codes = set()
...
def analyze_bangalore_calls(calls_filepath: str = 'calls.csv') -> Tuple[List[str], float]:
    """
...
def print_analysis_results(called_codes: List[str], bangalore_percentage: float) -> None:
    """
    ...
    print(f"{bangalore_percentage:.2f} percent of calls from fixed lines in Bangalore "
