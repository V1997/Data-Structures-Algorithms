...
from enhanced_problem4 import (
    sort_012_counting,
    sort_012_functional,
    sort_012_inplace,
)
from enhanced_task2 import find_longest_caller, parse_call_duration
...
class TestFileSearcher:
    ...
    def temp_dir_structure(self):
        ...
        dirs = ["subdir1", "subdir2", "subdir1/nested", "empty_dir"]
    ...
    def test_find_files_with_depth_limit(self, temp_dir_structure):
        ...
        assert (
            len(txt_files_depth2) == 3
        )  # file1.txt, subdir1/nested_file.txt, subdir2/another.txt
...
class TestUnscrambleCSProblems:
    ...
    def test_phone_number_analyzer(self):
        ...
        analyzer = PhoneNumberAnalyzer()        # Test different phone number types
        ...
        assert analyzer.is_bangalore_number("(080)12345678") is True
        assert analyzer.is_bangalore_number("(022)87654321") is False
